...
if [ -f "static/protected-photos.enc" ]; then
    ...
    openssl enc -d -aes-256-cbc -salt -pbkdf2 -iter 100000 -md sha256 -pass env:PHOTO_DECRYPTION_KEY -in static/protected-photos.enc | tar xzf - -C static/img/protected
